...
## 2.4. editar la versión de la aplicación
> package.json
```
  "version": "1.0.0",
```

## 2.5. Sincronizar el proyecto con Github - branch: stage
```vim
git add .
...
# test
docker run --rm --name api -p 3080:3080 $REGISTRY/kubelabs_publicapi:1.0.0
