...
## 6.4. Edit replicas in GitHub
> ArgoCD SYNC (self heal)

## 6.5. Delete Application
## 6.6. Option 2: App YAML (Git "OPS" repo)
> [public-api YAML](./assets/apps-files/../argo/apps/public-api.yaml)
- Create folder in OPS repo: apps/stage
- public-api.yaml
```vim
...
## 6.7. Check ArgoCD UI Apps
## 6.8. Check Pods: Running 2 replicas
